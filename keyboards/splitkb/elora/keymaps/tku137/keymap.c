 ...
 * |--------+------+------+------+------+------|      |------|  |------|      |------+------+------+------+------+--------|
 * |  Esc   |   Q  |   W  |   E  |   R  |   T  |      |LCtrl |  | RCtrl|      |   Y  |   U  |   I  |   O  |   P  |  \  |  |
 * |--------+------+------+------+------+------|      |------|  |------|      |------+------+------+------+------+--------|
 * |  Sft   |   A  |   S  |   D  |   F  |   G  |      | LAlt |  | RAlt |      |   H  |   J  |   K  |   L  | ;  : |  Sft   |
 * |--------+------+------+------+------+------+------+------|  |------|------+------+------+------+------+------+--------|
 * | LCtrl  |   Z  |   X  |   C  |   V  |   B  |Adjust|F-Keys|  |Spotl |MCtrl |   N  |   M  | ,  < | . >  | /  ? | RCtrl  |
 * `----------------------+------+------+------+------+------|  |------+------+------+------+------+----------------------'
 *                        | LAlt | LGUI | Enter| Space| Nav  |  | Sym  | Bksp | Tab  | RGUI | RAlt |
 *                        |      |      |      |      |      |  |      |      |      |      |      |
 *                        `----------------------------------'  `----------------------------------'
 *
 * ,----------------------------.      ,------.                 ,----------------------------.      ,------.
 ...
 */
    [_QWERTY] = LAYOUT_myr(
      KC_TILD ,  KC_1  ,  KC_2  ,  KC_3  ,  KC_4  ,  KC_5  ,          KC_LSFT,     KC_RSFT,           KC_6  ,  KC_7  ,  KC_8  ,  KC_9  ,  KC_0  , KC_MINS,
      KC_ESC  ,  KC_Q  ,  KC_W  ,  KC_E  ,  KC_R  ,  KC_T  ,          KC_LCTL,     KC_RCTL,           KC_Y  ,  KC_U  ,  KC_I  ,  KC_O  ,  KC_P  , KC_BSLS,
      KC_LSFT ,  KC_A  ,  KC_S  ,  KC_D  ,  KC_F  ,  KC_G  ,          KC_LALT,     KC_RALT,           KC_H  ,  KC_J  ,  KC_K  ,  KC_L  , KC_SCLN, KC_RSFT,
      KC_LCTL ,  KC_Z  ,  KC_X  ,  KC_C  ,  KC_V  ,  KC_B  , FKEYS  , ADJUST ,     CMD_SPC, KC_MCTL,  KC_N  ,  KC_M  , KC_COMM, KC_DOT , KC_SLSH, KC_RCTL,
                                  KC_LALT, KC_LGUI, KC_ENT , KC_SPC , NAV    ,      SYM   , KC_BSPC, KC_TAB , KC_RGUI, KC_RALT,
 ...
 * |   ~    |   1  |   2  |   3  |   4  |   5  |      |LShift|  |RShift|      |   6  |   7  |   8  |   9  |   0  |  -  _  |
 * |--------+------+------+------+------+------|      |------|  |------|      |------+------+------+------+------+--------|
 * |  Esc   |   Q  |   W  |   F  |   P  |   B  |      |LCtrl |  | RCtrl|      |   J  |   L  |   U  |   Y  | ;  : |  \  |  |
 * |--------+------+------+------+------+------|      |------|  |------|      |------+------+------+------+------+--------|
 * |  Sft   |   A  |   R  |   S  |   T  |   G  |      | LAlt |  | RAlt |      |   M  |   N  |   E  |   I  |   O  |  Sft   |
 * |--------+------+------+------+------+------+------+------|  |------|------+------+------+------+------+------+--------|
 * | LCtrl  |   Z  |   X  |   C  |   D  |   V  |Adjust|F-Keys|  |Spotl |MCtrl |   K  |   H  | ,  < | . >  | /  ? | RCtrl |
 * `----------------------+------+------+------+------+------|  |------+------+------+------+------+----------------------'
 *                        | LAlt | LGUI | Enter| Space| Nav  |  | Sym  | Bksp | Tab  | RGUI | RAlt |
 *                        |      |      |      |      |      |  |      |      |      |      |      |
 *                        `----------------------------------'  `----------------------------------'
 ...
 */
    [_COLEMAK_DH] = LAYOUT_myr(
      KC_TILD ,  KC_1  ,  KC_2  ,  KC_3  ,  KC_4  ,  KC_5  ,          KC_LSFT,     KC_RSFT,           KC_6  ,  KC_7  ,  KC_8  ,  KC_9  ,  KC_0  , KC_MINS,
      KC_ESC  ,  KC_Q  ,  KC_W  ,  KC_F  ,  KC_P  ,  KC_B  ,          KC_LCTL,     KC_RCTL,           KC_J  ,  KC_L  ,  KC_U  ,  KC_Y  , KC_SCLN, KC_BSLS,
      KC_LSFT ,  KC_A  ,  KC_R  ,  KC_S  ,  KC_T  ,  KC_G  ,          KC_LALT,     KC_RALT,           KC_M  ,  KC_N  ,  KC_E  ,  KC_I  ,  KC_O  , KC_RSFT,
      KC_LCTL ,  KC_Z  ,  KC_X  ,  KC_C  ,  KC_D  ,  KC_V  , FKEYS  , ADJUST ,     CMD_SPC, KC_MCTL,  KC_K  ,  KC_H  , KC_COMM, KC_DOT , KC_SLSH, KC_RCTL,
                                  KC_LALT, KC_LGUI, KC_ENT , KC_SPC , NAV    ,      SYM   , KC_BSPC, KC_TAB , KC_RGUI, KC_RALT,
 ...
 * |   I    | Shift|  A   |  W   |  D   |  F   |      |      |  |      |      |      |      |      |      |      |        |
 * |--------+------+------+------+------+------+------+------|  |------|------+------+------+------+------+------+--------|
 * |   M    | Ctrl |  Z   |  S   |  C   |  V   |  T   |QWERTY|  |      |      |      |      |      |      |      |        |
 * `----------------------+------+------+------+------+------|  |------+------+------+------+------+----------------------'
 *                        |Bkspce| LAlt | Space| Tab  | GMEXT|  |      |      |      |      |      |
 *                        |      |      |      |      |      |  |      |      |      |      |      |
 *                        `----------------------------------'  `----------------------------------'
 *
 * ,-----------------------------.      ,------.                ,---------------------------.      ,------.
 ...
 */
     [_GAMING] = LAYOUT_myr(
       KC_F5  ,  KC_1  ,  KC_2  ,  KC_3  ,  KC_4  ,  KC_5  ,          _______, _______,          _______, _______, _______, _______, _______, _______,
       KC_J   ,  KC_ESC,  KC_Q  ,  KC_X  ,  KC_E  ,  KC_R  ,          _______, _______,          _______, _______, _______, _______, _______, _______,
       KC_I   ,  KC_LSFT, KC_A  ,  KC_W  ,  KC_D  ,  KC_F  ,          _______, _______,          _______, _______, _______, _______, _______, _______,
       KC_M   ,  KC_LCTL, KC_Z  ,  KC_S  ,  KC_C  ,  KC_V  ,  KC_T  , QWERTY , _______, _______, _______, _______, _______, _______, _______, _______,
                                  KC_BSPC, KC_LALT, KC_SPC , KC_TAB , GMEXT  , _______, _______, _______, _______, _______,

       _______, _______, _______, _______,          _______,                   _______, _______, _______, _______,          _______
     ),

/*
 * Extended Gaming Layer: for additional controls
 *
 * ,-------------------------------------------.      ,------.  ,------.      ,-------------------------------------------.
 * |  Home  |  F1  |  F2  |  F3  |  F4  |  F5  |      |      |  |      |      |      |      |      |      |      |        |
 * |--------+------+------+------+------+------|      |------|  |------|      |------+------+------+------+------+--------|
 ...
 * `-----------------------------'      `------'                `---------------------------'      '------'
 */
     [_GAMING_EXT] = LAYOUT_myr(
       KC_HOME,  KC_F1 ,  KC_F2 ,  KC_F3 ,  KC_F4 ,  KC_F5 ,          _______, _______,          _______, _______, _______, _______, _______, _______,
       KC_PGUP,  KC_6  ,  KC_G  ,  KC_B  ,  KC_T  ,  KC_7  ,          _______, _______,          _______, _______, _______, _______, _______, _______,
       KC_PGUP, _______,  KC_Y  ,  KC_H  ,  KC_N  ,  KC_O  ,          _______, _______,          _______, _______, _______, _______, _______, _______,
       KC_END , _______,  KC_U  ,  KC_K  ,  KC_L  ,  KC_P  , _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
                                  _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
