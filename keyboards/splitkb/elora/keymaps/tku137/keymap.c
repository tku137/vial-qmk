 ...
 * |   I    | Shift|  A   |  W   |  D   |  F   |      |      |  |      |      |      |      |      |      |      |        |
 * |--------+------+------+------+------+------+------+------|  |------|------+------+------+------+------+------+--------|
 * |   M    | Ctrl |  Z   |  S   |  C   |  V   |Bkspce|QWERTY|  |      |      |      |      |      |      |      |        |
 * `----------------------+------+------+------+------+------|  |------+------+------+------+------+----------------------'
 *                        |GMEXT | LAlt |  Tab | Space|  NAV |  |      |      |      |      |      |
 *                        |      |      |      |      |      |  |      |      |      |      |      |
 *                        `----------------------------------'  `----------------------------------'
 *
 * ,-----------------------------.      ,------.                ,---------------------------.      ,------.
 ...
 */
     [_GAMING] = LAYOUT_myr(
       ...
       KC_M   ,  KC_LCTL, KC_Z  ,  KC_S  ,  KC_C  ,  KC_V  , KC_BSPC, QWERTY , _______, _______, _______, _______, _______, _______, _______, _______,
                                  GMEXT  , KC_LALT, KC_TAB , KC_SPC , NAV    , _______, _______, _______, _______, _______,
 ...
 */
     [_GAMING_EXT] = LAYOUT_myr(
       ...
       KC_PGUP, _______,  KC_G  ,  KC_B  ,  KC_T  ,  KC_6  ,          _______, _______,          _______, _______, _______, _______, _______, _______,
