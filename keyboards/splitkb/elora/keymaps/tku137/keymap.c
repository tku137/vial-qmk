...
static bool oled_mode = false; // Flag for OLED mode
 ...
 */
    [_ADJUST] = LAYOUT_myr(
      ...
      OLED_TGL, _______, _______, QWERTY , _______, _______,         _______, _______,         RGB_M_SW, _______, _______, _______,  _______,OLED_TGL,
      _______, _______, _______, DVORAK , _______, _______,        _______, _______,          RGB_TOG, RGB_SAI, RGB_HUI, RGB_VAI,  RGB_MOD, _______,
      _______, _______, _______, COLEMAK, _______, _______,_______, _______, _______, _______,OLED_TGL, RGB_SAD, RGB_HUD, RGB_VAD, RGB_RMOD, _______,
                                 _______, _______, _______,_______, _______, _______, _______, _______, _______, _______,
    ...
    switch (keycode) {
        case OLED_TGL:
            if (record->event.pressed) {
                oled_clear();
                oled_mode = !oled_mode; // Toggle OLED mode on key press
            }
...
bool oled_task_user(void) {
    ...
    if (is_keyboard_master()) {
        ...
        // If we are in OLED render mode 1
        if (oled_mode) {
            ...
            // Render Keyboard LED Status
            oled_set_cursor(0, 14);
            render_led_status();

        // If we are in OLED render mode 2
        } else {
    ...
    // Secondary side rendering
        ...
        // If we are in OLED render mode 2
            ...
            // Render large modifier status
            oled_set_cursor(0, 3);
            render_modifiers_l(modifiers, 7);
