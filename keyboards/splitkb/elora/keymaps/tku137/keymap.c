 ...
 * |        |  F1  |  F2  |  F3  |  F4  |      |      |      |  |      |      |KeyCast|     |      |      |      |        |
 * |--------+------+------+------+------+------|      |------|  |------|      |------+------+------+------+------+--------|
 * |        |  F5  |  F6  |  F7  |  F8  |      |      |      |  |      |      |Hyper | GUI  | Alt  | Ctrl |Shift |        |
 * |--------+------+------+------+------+------+------+------|  |------|------+------+------+------+------+------+--------|
 * |        |  F9  | F10  | F11  | F12  |      | LPad |MContr|  |MContr| LPad |      |      |      |      |      |        |
 * `----------------------+------+------+------+------+------|  |------+------+------+------+------+----------------------'
 *                        |      |      |      |      |      |  |      |      |      |      |      |
 *                        |      |      |      |      |      |  |      |      |      |      |      |
 *                        `----------------------------------'  `----------------------------------'
 ...
 */
    [_FUNCTION] = LAYOUT_myr(
      ...
      _______,  KC_F1 ,  KC_F2 ,  KC_F3 ,  KC_F4 , _______,          _______, _______,          KEYCAST, _______, _______, _______, _______, _______,
      _______,  KC_F5 ,  KC_F6 ,  KC_F7 ,  KC_F8 , _______,          _______, _______,          KC_HYPR, KC_RGUI, KC_LALT, KC_RCTL, KC_RSFT, _______,
      _______,  KC_F9 ,  KC_F10,  KC_F11,  KC_F12, _______, KC_LPAD, KC_MCTL, KC_MCTL, KC_LPAD, _______, _______, _______, _______, _______, _______,
                                 _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
 ...
 */
    [_ADJUST] = LAYOUT_myr(
      ...
      _______, _______, _______, QWERTY , KC_BRIU, _______,         _______, _______,          RGB_M_SW,_______, _______, _______,  _______, _______,
      _______, _______, _______, _______, KC_BRID, _______,         _______, _______,          RGB_TOG, RGB_SAI, RGB_HUI, RGB_VAI,  RGB_MOD, _______,
